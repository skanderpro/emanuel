    ...
    steps: [
        {
            ...
            text: __(
                'The style editor allows you to edit the styles, colours, and typographic elements of your site. To access the style editor, first open the Editor via Appearance > Editor.',
                'extendify',
            ),
        ...
        },
        {
            ...
            text: __(
                'The styles panel allows you to to customise the appearance of your site. It includes style variations, colours, typography, and more.',
                'extendify',
            ),
            attachTo: {
        ...
        {
            title: __('Typography', 'extendify'),
            text: __('Choose a typographic element to customise.', 'extendify'),
            attachTo: {
                element: '.edit-site-global-styles-sidebar__navigator-screen',
                offset: {
                    marginTop: 0,
        ...
        },
        {
            title: __('Layout', 'extendify'),
            text: __(
                'From here you can customise the dimensions, padding, and margins used for your site layout.',
                'extendify',
            ),
            attachTo: {
                element: '.edit-site-global-styles-sidebar__navigator-screen',
