                            ...
                            <div class="rental-detal-right">
                                <div class="rental-detal-params">
                                    <div class="rental-detal-params-item">
                                        ...
                                        <div class="rental-detal-params-item-label"><?php rwmb_the_value( 'rooms' ) ?></div>
                                    </div>
                                    <div class="rental-detal-params-item">
                                        <div class="rental-detal-params-item-title">Floor</div>
                                        <div class="rental-detal-params-item-label"><?php rwmb_the_value( 'floor' ) ?></div>
                                    </div>
                                    <div class="rental-detal-params-item">
                                        <div class="rental-detal-params-item-title">
                                            Living space
                                        </div>
                                        <div class="rental-detal-params-item-label"><?php rwmb_the_value( 'living_space' ) ?></div>
                                    </div>
                                </div>
                            </div>
                        </div>
