    ...
    <div class="container">
        <div class="header-content__inner">
            ...
            <div class="header-content__inner-img">
                <picture>
                    <img src="<?php echo $settings['map']['url']; ?>" alt="" />
                </picture>
            </div>
            <div class="header-content__inner-card">
                <div class="header-content__inner-card-title">
                    <?php echo $title; ?>
                </div>
                <div class="header-content__inner-card-text">
	                <?php echo $description; ?>
                </div>
                <div class="header-content__inner-card-contact">
                    <div class="header-content__inner-card-contact-item">
                        <svg
                                width="24"
                                height="24"
                                viewBox="0 0 24 24"
                        ...
                        >
                            <g clip-path="url(#clip0_365_2289)">
                                <path
